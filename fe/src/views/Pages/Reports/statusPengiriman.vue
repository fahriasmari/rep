  ...
  <div>
    <div id="listed-report">
      ...
      >
        ...
        <h4 class="text-default m-0">Data 2 Menit</h4>
      </div>
            ...
            <div class="card">
              ...
              <div class="p-3 w-100">
                ...
                <div class="row">
                  ...
                  <!-- Level: Kab/Kot -->
                  <template v-if="this.$store.state.auth.level == 2">
                    <div class="col-2 pr-0">
                      <el-select
                        class="w-100"
                        v-model="selected.jenisIndustri"
                ...
                <!-- <div class="row my-4">
                  <div class="col-12">
                    <div class="col-2">
                      <base-button class="w-100" size="md" type="secondary" click="downloadData()">1 Jam</base-button>
                    </div>
                    <div class="col-2">
                      <base-button class="w-100" size="md" type="secondary" click="downloadData()">1 Hari</base-button>
                    </div>
                    <div class="col-2">
                      <base-button class="w-100" size="md" type="secondary" click="downloadData()">1 Bulan</base-button>
                    </div>
                    <div class="col-2">
                      <base-button class="w-100" size="md" type="secondary" click="downloadData()">2 Bulan</base-button>
                    </div>
                  </div>
                </div> -->
              </div>
...
export default {
  ...
  methods: {
    ...
    getTableData(params) {
      ...
      axios
        .get(
          `${defaults.baseURL}/report/listpengiriman/${auth._id}?${params.join(
            "&"
          )}`,
          { headers: { token: this.$store.state.token } }
        )
    ...
    exportExcel() {
      const auth = JSON.parse(localStorage.getItem("auth-data"));
      window.open(
        `${defaults.baseURL}/report/listpengiriman-export/${
          auth._id
        }?${this.arrayBody.join("&")}`,
        "_blank"
      );
    ...
    getDataDownload() {
      ...
      axios
        .get(
          `${defaults.baseURL}/report/listpengiriman-download/${
            auth._id
          }?${params.join("&")}`,
          { headers: { token: this.$store.state.token } }
        )
            ...
            axios
              ...
              .then(res => {
                ...
                if (
                  ...
                  console.log("temp prof", this.companyDataDownload);
                  let bodyProfile = [
                    ...
                    // ["NO. IZIN", tempProfie.compPermitDate],
                    ["INSTANSI PENERBIT", tempProfie.compInstance],
                    ["TANGGAL TERBIT IZIN", tempProfie.compPermitDate]
                    // ["TANGGAL TERBIT IZIN", tempProfie.compPermit],
                  ];
                  console.log("body", bodyProfile);
                  doc.autoTable({
                    theme: "plain",
                    body: bodyProfile,
                    columnStyles: {
